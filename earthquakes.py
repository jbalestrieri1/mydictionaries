...
print(f'The total number of earthquakes is:', len(earthquakes['features']))
...
for place in eq_dict:
    numbers = eq_dict[place]
    print(f'Location: {place}')
    print(f'Magnitude: {numbers[0]}')
    print(f'Longitude: {numbers[1]}')
    print(f'Latitude: {numbers[2]}')
    print()
